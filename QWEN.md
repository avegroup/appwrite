...
#### Changes Made
Были внесены изменения в `/app/controllers/api/account.php` для сохранения телефона пользователя из OAuth2 провайдеров:
1. Извлечение телефона: `$phone = $oauth2->getUserPhone($accessToken);`
2. Сохранение телефона при создании нового пользователя
3. Обновление телефона при аутентификации существующего пользователя
